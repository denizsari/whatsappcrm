    ...
    try {
      ...
      if (error) {
        ...
        if (data.user && !data.user.email_confirmed_at) {
          ...
          // If email confirmation is disabled, go to onboarding
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-bold mb-4">İşletmenizi Büyütmeye Başlayın</h1>
            <p className="text-xl text-slate-300 leading-relaxed">
              Ücretsiz hesap oluşturun ve WhatsApp CRM'in gücünü keşfedin.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h3 className="font-semibold">Ücretsiz Başlangıç</h3>
                <p className="text-slate-400">Kredi kartı gerektirmez, hemen başlayın</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-slate-400">5 dakikada WhatsApp'ınızı bağlayın</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h3 className="font-semibold">Her İşletme İçin</h3>
                <p className="text-slate-400">Kuaför, berber, danışman, emlak ve daha fazlası</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          <Card className="border-0 shadow-2xl">
            <CardHeader className="text-center pb-8">
              <CardTitle className="text-3xl font-bold text-slate-900">Hesap Oluştur</CardTitle>
